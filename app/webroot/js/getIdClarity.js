...
function showViewClarity(idClarity){
  document.getElementById("viewClarity").innerHTML = "<img src='/demandas/CakeVersion/img/ca.jpg' style='cursor:pointer;' title='Clique aqui para testar a integração da demanda com o sistema Clarity!'></img>";
  document.getElementById('demandaFrame').src = "http://www-dtpprojetos/niku/nu#action:pma.ideaProperties&id=" + idClarity;
}
