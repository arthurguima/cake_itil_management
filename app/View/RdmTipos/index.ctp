      ...
      <h3 class="page-header">
        ...
        <div class="col-lg-2 pull-right">
          <?php echo $this->Html->link("<i class='fa fa-plus'></i> Nova",
             array('controller' => 'rdmtipos', 'action' => 'add'),
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading"><b> Lista de Tipos de RDMs </b></div>
      <div class="panel-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover" id="dataTables-rdm">
            ...
            <tbody>
              <?php foreach ($rdmTipos as $tipo): ?>
                <tr>
                   <td><?php echo $tipo['RdmTipo']['nome']; ?></td>
                   <td><?php echo $this->Tables->getMenu('rdmtipos', $tipo['RdmTipo']['id'], 12); ?></td>
                </tr>
              <?php endforeach; ?>
              <?php unset($tipo); ?>
            </tbody>
