...
<div class="row">
	...
	<div class="col-lg-9 col-md-12 col-sm-12 pull-left delete-indis">
		<div class="panel panel-warning">
			<div class="panel-heading">
				<p><h3 class="panel-title"><b><i class="fa fa-clock-o" style="font-size: 20px;"></i> <span>Estimativa de Disponibilidade</b> </span>
				...
				<div class="tab-content">
					<?php
						...
						foreach ($clientesindis as $key => $cli){
							...
							echo "<h4 class='pull-left col-lg-12'>";
								if(date("d") < $cli[0]['Cliente']['dt_ini_disponibilidade']+1){
